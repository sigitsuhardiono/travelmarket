    ...
    <div class="flat-panel">
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <p><?php echo $DataPaket->company->nama ?></p>
                ...
                <div class="row">
                    <div class="col-md-8 col-xs-6">
                        <div class="price">Rp <span class="value"><?php echo number_format($DataPaket->harga) ?></span></div>
                    </div>
                    <div class="col-md-4 col-xs-6">
                        <?php echo Html::a('PESAN', Url::to(['pesan-paket-wisata', 'id' => $DataPaket->id]), ['class' => 'btn btn-block btn-warning']) ?>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-md-8 pv-30">
                                    ...
                                    <div class="light-gray-bg p-20 bordered clearfix">
                                        ...
                                        <div class="product elements-list pull-right clearfix">
                                            <a href="<?php echo Url::to(['pesan-paket-wisata', 'id' => $DataPaket->id])?>" class="margin-clear btn btn-default">Pesan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
